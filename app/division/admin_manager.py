...
class Admin_Menu_manager:
    ...
    def add_food(self):
        ...
        try:
            while True:
                ...
                category = input("\033[96menter category: ")
    ...
    def delete_food(self):
        try:
            ...
            category = input("\033[97menter category: ")
            name = input("please enter food name to delete: ")
    ...
    def update_food(self):
        try:
            ...
            if category in data and name in data[category]:
                ...
                data[category][name]["half_plate"] = half
                data[category][name]["full_plate"] = full
